...
import com.easemob.chatuidemo.fragment.CentreFragment;
import com.easemob.chatuidemo.fragment.FindFragment;
import com.easemob.chatuidemo.fragment.Fragment1;
import com.easemob.chatuidemo.fragment.NeswFragment;
import com.easemob.chatuidemo.view.SystemBarTintManager;
...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	private FindFragment contactListFragment;
	// private ChatHistoryFragment chatHistoryFragment;
	private ChatAllHistoryFragment chatHistoryFragment;
	private CentreFragment settingFragment;
	private NeswFragment neswFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			...
			tintManager.setStatusBarTintResource(R.color.default_line_indicator_selected_color);//通知栏所需颜色
		}else{
		...
		contactListFragment = new FindFragment();
		settingFragment = new CentreFragment();
		neswFragment=new NeswFragment();
           fragment=new Fragment1();
		fragments = new Fragment[] { chatHistoryFragment,neswFragment, contactListFragment, settingFragment };
		// 添加显示第一个fragment
	...
	private void initView() {
		...
		mTabs[3]=(Button)findViewById(R.id.btn_settin);
		// 把第一个tab设为选中状态
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						// 显示帐号在其他设备登陆dialog
						showConflictDialog();
					} else {fragment.errorItem.setVisibility(View.VISIBLE);
